        ...
        <div className={y > 0 ? 'lamar-container lamar-container-scroll ' : 'lamar-container'}>
          ...
          <section className={y > 0 ? 'rightContainer rightContainer-scroll ' : 'rightContainer'}>
            ...
            <ul className='right-nav'>
              ...
              <li>
                <a href='https://www.instagram.com/mariettamontreal2022/?utm_medium=copy_link' target='_blank' rel='noreferrer'>
                  <a>
              ...
              <li>
                <a href='https://www.facebook.com/monty.ramzi' target='_blank' rel='noreferrer'>
                  <a>
