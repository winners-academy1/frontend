	...
	return (
		<>
			<section className="about-us" id="#About">
				...
				<div className="lamar-container">
					<h5>
					At Winners Academy, we are dedicated to helping students succeed in PTE Academic and PTE Core tests through our professional online courses. We do not only provide comprehensive PTE Academic and PTE Core courses, but we also offer ongoing support to our students. We understand that success in the exam is not just about preparing well, but also about getting feedback, following up, and receiving support throughout the process. With our experienced instructors and advanced learning resources, our courses are carefully crafted to assist students in achieving their goals and reaching their full potential. So, enroll with us today and rest assured that you will receive the best preparation and support for the PTE Academic and PTE Core tests.
					</h5>
