        ...
        <div className='lamar-container'>
          <div className='box'>
            ...
            <ul className='social'>
              ...
              <li>
                <a href='mailto:Mariettamontreal@gmail.com' className='twitter' target='_blank'>
                  <i className='far fa-envelope icon'></i>
                </a>
              </li>
            </ul>
            <p className='text'>Welcome to our website do not hesitate to reach us.</p>
          </div>
          <div className='box'>
            <ul className='links'>
              <li>
          ...
          <div className='box'>
            ...
            <div className='line'>
              <i className='far fa-envelope icon'></i>
              <a href='mailto:Mariettamontreal@gmail.com' target='_blank' className='info'>
